...
//user.internet_bill=user.expenses[3];
    ...
    printf("\nId: %d",user.Id);
     //printf("\nPassword: %s\n\n",user.password);
     printf("\n\nyour total estimated monthly expense is %f taka\n",user.total);
    printf("1--food cost=%.2f tk is  %f percent of your total cost\n",user.expenses[0],user.expenses_percentage[0]);
    printf("2--electricty cost=%.2f tk is %f  percent of your total cost\n",user.expenses[1],user.expenses_percentage[1]);
    printf("3--Transportation cost=%.2f tk is %f  percent of your total cost\n",user.expenses[2],user.expenses_percentage[2]);
    printf("4--house rent=%.2f tk is fixed and %f of your total cost\n",user.expenses[3],user.expenses_percentage[3]);
    printf("5--internet bill=%.2f tk is fixed and %f of your total cost\n",user.expenses[4],user.expenses_percentage[4]);
